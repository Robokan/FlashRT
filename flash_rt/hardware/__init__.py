...
def detect_arch() -> str:
    ...
    Supported:
        ...
        ``"rtx_sm121"`` — DGX Spark GB10 / Blackwell, SM121 (cc 12.1)
    ...
    raise RuntimeError(
        ...
        f"SM121 (DGX Spark GB10), SM89 (RTX 4090), "
